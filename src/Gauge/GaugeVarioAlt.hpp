...
#ifndef GAUGE_VARIO_ALT_H
#define GAUGE_VARIO_ALT_H
...
class GaugeVarioAlt : public AntiFlickerWindow
{
  ...
  struct BallastGeometry {
    ...
    BallastGeometry( VarioAltLook &look, const PixelRect &rc) noexcept;
  };
  ...
  struct BugsGeometry {
    ...
    BugsGeometry( VarioAltLook &look, const PixelRect &rc) noexcept;
  };
  ...
  struct LabelValueGeometry {
    ...
    LabelValueGeometry( VarioAltLook &look, PixelPoint position) noexcept;

    static unsigned GetHeight( VarioAltLook &look) noexcept;
  };
  ...
  struct Geometry {
    ...
    Geometry() = default;
    Geometry( VarioAltLook &look, const PixelRect &rc) noexcept;
  } geometry;
...
public:
  GaugeVarioAlt(const FullBlackboard &blackboard,
             ContainerWindow &parent, VarioAltLook &look,
