...
#ifndef GAUGE_GLIDE_H
#define GAUGE_GLIDE_H
...
class GaugeGlide : public AntiFlickerWindow
{
...
public:
  GaugeGlide(const FullBlackboard &blackboard,
             ContainerWindow &parent, GlideLook &look,
