...
const char AppGaugeVarioRange[] = "AppGaugeVarioRange";
const char AppGaugeVarioAlternate[] = "AppGaugeVarioAlternate";
...
const char EnableGlideRibbon[] = "EnableGlideRibbon";
