...
constexpr std::string_view AppGaugeVarioAlternate = "AppGaugeVarioAlternate";
constexpr std::string_view AppGaugeVarioRange = "AppGaugeVarioRange";
...
constexpr std::string_view EnableNavRibbon = "EnableNavRibbon";
constexpr std::string_view EnableGlideRibbon = "EnableGlideRibbon";
